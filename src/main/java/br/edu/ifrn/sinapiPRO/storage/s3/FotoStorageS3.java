package br.edu.ifrn.sinapiPRO.storage.s3;
...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "aw-sinapiPRO-fotos";
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://s3-us-west-2.amazonaws.com/aw-sinapiPRO-fotos/" + foto;
		}
